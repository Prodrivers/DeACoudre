...
public class DaC implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String cmdValue, String[] args) {
		...
		if (command != null) {
			...
			if (cmdName.equalsIgnoreCase("filetomysql")) {
				...
				if (playerData.getData().getBoolean("converted", false) == true) {
								...
								try {
									if (query.next()) {
										...
										mysql.update("INSERT INTO " + config.tablePrefix
												...
												+ language + "','" + String.valueOf(gamesPlayed) + "','"
												+ String.valueOf(gamesWon) + "','" + String.valueOf(gamesLost) + "','"
												+ String.valueOf(DaCdone) + "','" + ((completedArena) ? "1" : "0")
												+ "','" + ((eightPlayersGame) ? "1" : "0") + "','"
												+ ((reachRound100) ? "1" : "0") + "','" + ((DaCon42) ? "1" : "0")
												+ "','" + ((colorRivalery) ? "1" : "0") + "','"
												+ ((longTime) ? "1" : "0") + "','" + String.valueOf(timePlayed) + "','"
												+ String.valueOf(moneyGains) + "');");
									}
								...
								try {
									if (query.next()) {
										...
										mysql.update("INSERT INTO " + config.tablePrefix
												...
												+ name + "','" + world + "','" + String.valueOf(minAmountPlayer) + "','"
												+ String.valueOf(maxAmountPlayer) + "','" + String.valueOf(colorIndice)
												+ "','" + String.valueOf(plateformX) + "','"
												+ String.valueOf(plateformY) + "','" + String.valueOf(plateformZ)
												+ "','" + String.valueOf(plateformYaw) + "','"
												+ String.valueOf(plateformPitch) + "','" + String.valueOf(lobbyX)
												+ "','" + String.valueOf(lobbyY) + "','" + String.valueOf(lobbyZ)
												+ "','" + String.valueOf(lobbyYaw) + "','" + String.valueOf(lobbyPitch)
												+ "','" + String.valueOf(minPointX) + "','" + String.valueOf(minPointY)
												+ "','" + String.valueOf(minPointZ) + "','" + String.valueOf(maxPointX)
	...
	private void sendHelp(Player player, String cmdValue, String[] args) {
		...
		player.sendMessage(ChatColor.translateAlternateColorCodes('&', header));
		player.sendMessage(ChatColor.translateAlternateColorCodes('&',
				"&3" + local.keyWordHelpCategory + ": &7" + commandType.toString() + ", &3" + local.keyWordHelpPage
						+ ": &7" + String.valueOf(pageNumber) + "&8/&7"
